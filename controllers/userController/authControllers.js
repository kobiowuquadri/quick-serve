...
// const baseUrl = 'https://docify-backend.onrender.com/api/v1/auth'
...
//   const verificationToken = jwt.sign({email}, process.env.SECRET, {expiresIn: '1d'})
...
//   // Please verify your email by clicking on the following link: ${process.env.BASE_URL}/verify-email?token=${verificationToken}
